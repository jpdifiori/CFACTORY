...
export function UserMenu() {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-3 w-64 bg-[#0a0a0a] rounded-[2rem] border border-white/10 p-2 shadow-2xl z-[9999] animate-in fade-in slide-in-from-top-2 duration-300">
